const SoftwareDB = {
  resources: [
    // ==================== DJ SOFTWARE ====================
    {
      ...
      links: [
        { label: 'Descargar Gratis', url: 'https://rekordbox.com/es/download/', type: 'download' },
        {
          ...
          url: 'https://support.pioneerdj.com/hc/en-us/articles/4598241828761',
          type: 'archive',
        },
      ...
      icon: 'DAW',
      recommendation:
        'Elige Rekordbox 7 si tu computadora es moderna. Si no, usa Rekordbox 6 o Mixxx.',
    },
    {
      id: 'rekordbox-6',
      name: 'Rekordbox 6',
      ...
      links: [
        {
          label: 'Descargar Gratis (Oficial)',
          url: 'https://support.pioneerdj.com/hc/en-us/articles/8112764645785',
          type: 'download',
        },
        {
          label: 'Descargar v6 (alternativo)',
          url: 'https://rekordbox.com/en/download/',
          type: 'download',
        },
        {
          label: 'Tutorial Export USB',
          url: 'https://www.youtube.com/results?search_query=rekordbox+6+export+usb+cdj',
          type: 'tutorial',
        },
      ],
      ...
      icon: 'DAW',
      recommendation:
        'MEJOR OPCIÓN PARA COMPUS ANTIGUAS → Descarga Rekordbox 6, no necesitas licencia.',
    },
    {
      id: 'rekordbox-5',
      name: 'Rekordbox 5',
      ...
      links: [
        {
          label: 'Descargar (Oficial)',
          url: 'https://support.pioneerdj.com/hc/en-us/articles/4598241828761',
          type: 'download',
        },
        {
          label: 'Guía de Versiones',
          url: 'https://djgym.mx/rekordbox-6-y-rekordbox-5/',
          type: 'guide',
        },
      ],
      ...
      icon: 'DAW',
      recommendation:
        'Solo si tu PC es muy vieja (Windows 7 / macOS Sierra). Prefiere Rekordbox 6 o Mixxx.',
    },
    {
      id: 'serato-dj-pro',
      name: 'Serato DJ Pro',
      ...
      links: [
        {
          ...
          url: 'https://serato.com/dj/lite/downloads',
          type: 'download',
        },
    ...
    },
    {
      ...
      links: [
        {
          ...
          url: 'https://www.native-instruments.com/en/specials/traktor-pro-3-demo/',
          type: 'download',
        },
        {
          label: 'Native Access',
      ...
      icon: 'DAW',
      recommendation:
        'La demo es ilimitada si no te importa reiniciar cada 30 min. Alternativa gratis: Mixxx.',
    },
    {
      id: 'virtual-dj',
      name: 'VirtualDJ 2026',
    ...
    },
    {
      ...
      links: [
        ...
        {
          label: 'App Store',
          url: 'https://apps.apple.com/app/djay-pro/id1533186218',
          type: 'download',
        },
      ],
    ...
    // ==================== STEM SEPARATION ====================
    {
      ...
      links: [
        {
          label: 'Descargar Gratis',
          url: 'https://www.practicesession.app/lamina/',
          type: 'download',
        },
      ],
    ...
    },
    {
      ...
      links: [
        {
          label: 'Descargar (GitHub)',
          url: 'https://github.com/mbianchidev/track2stem',
          type: 'source',
        },
      ],
      ...
      icon: 'STM',
      recommendation:
        'Para usuarios técnicos con Docker. La mejor alternativa open source a Moises.',
    },
    {
      id: 'misst',
      name: 'MISST',
    ...
    },
    {
      ...
      language: ['en', 'es', 'pt'],
      links: [{ label: 'Probar Gratis', url: 'https://moises.ai/', type: 'trial' }],
      tags: ['stems', 'ia', 'movil', 'web', 'moises'],
      icon: 'MOI',
      recommendation:
        'La mejor calidad de separación, pero el plan gratis es limitado. Alternativa: Lamina o StemDeck.',
    },
    ...
    // ==================== DJ UTILITIES ====================
    {
      ...
      icon: 'KEY',
      recommendation:
        'Mixxx incluye detección de key gratuita (no necesitas Mixed In Key si usas Mixxx).',
    },
    {
      id: 'rekord-buddy',
      name: 'Rekord Buddy',
      ...
      language: ['en'],
      links: [{ label: 'Comprar', url: 'https://rekordbuddy.com/', type: 'buy' }],
    ...
    },
    {
      ...
      language: ['en'],
      links: [{ label: 'Descargar', url: 'https://lexicondj.com/', type: 'download' }],
    ...
    },
    {
      ...
      language: ['en'],
      links: [{ label: 'Probar Gratis', url: 'https://rekordcloud.com/', type: 'trial' }],
    ...
    },
    {
      ...
      links: [{ label: 'Descargar Gratis', url: 'https://obsproject.com/', type: 'download' }],
      tags: ['streaming', 'grabacion', 'video', 'gratis', 'open-source'],
      icon: 'SW',
      recommendation:
        'ESTÁNDAR PARA STREAMING DE SETS → Usado por Boiler Room, DJs, radios online.',
    },
    {
      id: 'vb-cable',
      ...
      language: ['en'],
      links: [{ label: 'Descargar Gratis', url: 'https://vb-audio.com/Cable/', type: 'download' }],
    ...
    },
    {
      ...
      icon: 'AU',
      recommendation:
        'ALTERNATIVA GRATIS A LOOPBACK → Esencial para DJs con Mac que graban sus sets.',
    },
    ...
    },
    {
      ...
      language: ['en'],
      links: [{ label: 'Descargar Gratis', url: 'https://vital.audio/', type: 'download' }],
    ...
    // ==================== CREATIVE TOOLS ====================
    {
      ...
      links: [
        {
          label: 'Rekordbox XML Tool',
          url: 'https://github.com/macr0w/rekordbox2traktor',
          type: 'source',
        },
        {
          label: 'Rekordbox Buddy (Web)',
          url: 'https://www.rekordcloud.com/rb-tool/',
          type: 'webapp',
        },
      ],
    ...
    },
    {
      ...
      hasFreeTier: false,
      language: ['en', 'es', 'fr', 'de', 'ja'],
      links: [{ label: 'Ver Planes', url: 'https://www.beatport.com/', type: 'buy' }],
  ...
  getPricingBadge: function (pricing) {
    const badges = {
      ...
      freemium: { text: 'Freemium', color: '#ff9100' },
